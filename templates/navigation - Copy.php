<!--<div id="nav">
	...
	<h2 class="nav-padding">Create</h2>
	<div class="divider"></div>
	<ul>
	...
	<h2 class="nav-padding">Filter</h2>
	<div class="divider"></div>
	<ul>
		<li><a href="index.php" id="home">All</a></li>
		<li><a href="popular-all-time.php" id="popular">Popular</a></li>
		<li><a href="random.php" id="random">Random</a></li>
		<?php if ($user): ?>
	...
	<div class="divider"></div>
	<ul>
		<li><a href="http://www.facebook.com/pages/Memify-Community/150173858437134">Facebook</a></li>
		<li><a href="https://twitter.com/FaisalNahian">Twitter</a></li>
	</ul>
