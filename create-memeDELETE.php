...
<section id="middle"> 
			...
			<table width="100%" height="100%" align="center">
				...
				<a href="index.php"><img src="img/logo-large.png" width="300" height="80" alt="memify" class="center" /></a>
							...
							<br><br><p class="center">Choose an option below to get started!</p>
				</div>
				...
				<div>
                    ...
                    <li>
                        <a href="create.php">
                            <div class="landing-content">
                                ...
                                <h3 class="landing-sub">using your facebook 
								images</h3>                              
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="create-from-url.php">
                            <div class="landing-content">
                                <h3 class="landing-sub">enter an</h3>
                                <h2 class="landing-main">Image URL</h2>
                            </div>
                        </a>
                    </li>
                </ul>
						   ...
						   <br><br><p class="center">Let's keep the humor clean, 
			and hilarious!!! ;-)</p><br><br>
